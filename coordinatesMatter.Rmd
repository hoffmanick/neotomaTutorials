...
coll_depth = raster::extract(bathy,st_coordinates(filteredColl_sf)) %>% cbind(filteredColl_sf)
site_depth = raster::extract(bathy,st_coordinates(site_sf)) %>% cbind(site_sf)
...
names(site_depths_cont) = c("depth","distance")

names(coll_depths_cont) = c("depth","distance")
