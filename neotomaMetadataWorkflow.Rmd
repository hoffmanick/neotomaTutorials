...
<ul>
<li>check whether a site in Neotoma is stored as a point or a polygon,</li>
<li>understand the difference between the Neotoma sites table and collectionunits table, and</li>
<li>use the Open Neotoma schema visualization to search for unfamiliar metadata tables.</li>
</ul>
...
First, let's load up some packages we'll need.
