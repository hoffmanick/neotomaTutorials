...
# A toy exercise 
(this part needs the most help - maybe junk this entire section - trying to figure out a way to demonstrate where or that the collection unit location data matter)
...
coll_mod = glm(Cyperaceae ~ bio1 + bio2 + bio3 + bio4 + bio5 + bio6 + bio7 + bio8 + bio9 + bio10 + bio11 + bio12 + bio13 + bio14 + bio15 + bio16 + bio17 + bio18 + bio19, data=counts_coll_young)

coll_step = step(coll_mod)


site_mod = glm(Cyperaceae ~ bio1 + bio2 + bio3 + bio4 + bio5 + bio6 + bio7 + bio8 + bio9 + bio10 + bio11 + bio12 + bio13 + bio14 + bio15 + bio16 + bio17 + bio18 + bio19, data=counts_site_young)
...
tm_shape(grass_lc_subset) + tm_raster(style="cont") + 
    ...
    tm_shape(site_sf) + tm_dots(col="lightblue",size=0.5,alpha=0.5) +
    tm_shape(coll_circle) + tm_borders(col="red",alpha=0.5) +
    tm_shape(site_circle) + tm_borders(col="lightblue",alpha=0.5)
