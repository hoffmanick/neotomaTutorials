...
thou = site_df[1:1000,] %>% dplyr::select(!geography)

sf_ex = geojson_sf(site_df$geography[1:1000]) %>% cbind(thou) %>% sf_geojson()
```
...
<img src="./images/sitemetadata.png">
